...
(function App() {
    ...
    <div class="box border-0">
        <div class="box-header py-3 d-flex justify-content-between">
            <span class="prevMonth pl-3">&#10096;</span>
            <span><strong id="s_m"></strong></span>
            <span class="nextMonth pr-3">&#10097;</span>
        </div>
        <div class="box-body">
...
{/* <div class="box border-0 mt-5 flex-fill d-none" id="event">
    <div class="box-header py-3 text-center">
        Add Event
        <button type="button" class="close hide">
            <span aria-hidden="true">&times;</span>
        </button>
    </div>
    <div class="box-body px-1 py-3">
