            ...
            <div class="col-xl-3 col-lg-4">
              <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <a href="{{ asset('storage/guru.xlsx') }}" class="btn btn-sm btn-primary"><i class="fas fa-arrow-circle-down"></i> File Contoh</a>
                </div>
                <div class="card-body">
                    <form action="{{ route('excel.guru') }}" class="user" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
